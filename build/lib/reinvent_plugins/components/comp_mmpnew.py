...
import sys
sys.path.append('.')#/lambda_stor/homes/avasan/REINVENT4/build/lib/reinvent_plugins/components')
import os 
print(os.getcwd())

from build.lib.reinvent_plugins.components.component_results import ComponentResults
from build.lib.reinvent_plugins.components.run_program import run_command
from build.lib.reinvent_plugins.components.add_tag import add_tag
from build.lib.reinvent_plugins.normalize import normalize_smiles
